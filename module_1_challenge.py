...
# YOUR CODE HERE!
def calc_present_value(fv,remaining_months,annual_discount_rate):
    present_value = fv / (1 + (annual_discount_rate/12)) ** remaining_months
...
#print(f"The present value of the loan is:" (present_value(future_value,remaining_months,discount_rate)))
